...
class Following extends StatefulWidget {
  Following({Key? key, required this.userRef, required this.userID})
      : super(key: key);
  dynamic userRef;
  String? userID;
  @override
...
class _FollowingState extends State<Following> {
  ...
  getFollowing(String userID) async {
    numFollowing =
        await DatabaseService().getNumFollowingFromID(widget.userID!);
          ...
          if (userSnap.id == loggedInUser!.email) {
            ...
            buttonToDisplay = ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  following.insert(index, followedId);
                  numFollowing += 1;
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          SingleChildScrollView(
            child: Column(children: [profileOverviewWidgets]),
          ),
        ])));
  }
}
